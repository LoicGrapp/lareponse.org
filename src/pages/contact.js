...
export function Contact() {
    return `
      ...
      <div class="max-w-[72rem] mx-auto">
        ...
        <!-- TITLE -->
        <div class="pb-[24px]">
          <h1 class="font-bold leading-none flex items-baseline gap-4 border-b-2 border-[var(--purple)]">
            <span class="text-[72px] md:text-[112px] text-[var(--purple)] font-bebas">
              06
            </span>
            <span class="text-[48px] md:text-[88px] text-[var(--white)] font-bebas">
              ${t('contact.heading')}
            </span>
          </h1>
        </div>
        ...
        <!-- MAIN GRID -->
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 bg-[var(--black)]">
          ...
          <div class="space-y-10 text-[13px] text-[var(--gray-p)]">
            ...
            <div class="border-l-[3px] border-[var(--purple)] pl-4 pr-4 font-mono-space">
              ...
              <p class="mt-4">${t('contact.2ndparagraph')}</p>
            </div>

            <div class="border border-[#2a2a2a] overflow-hidden">
          ...
          <!-- RIGHT SIDE FORM -->
          <div class="flex flex-col justify-between border border-[#2a2a2a] p-5 bg-[#151515] shadow-[5px_5px_0_var(--purple)]">
            ...
            <form class="space-y-8 text-[13px]">
              ...
              <div>
                ...
                <select class="w-full bg-transparent border-b border-[#2a2a2a] pb-2 focus:outline-none focus:border-[var(--purple)]">
              ...
              <div>
                ...
                <textarea
                  ...
                  class="w-full bg-transparent border-b border-[#2a2a2a] resize-none focus:outline-none focus:border-[var(--purple)]"
                ></textarea>
              </div>
